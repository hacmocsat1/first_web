...
<!-- calendar -->
<link rel="stylesheet" href="public/admin/css/monthly.css">
<!-- //calendar -->
<!-- //font-awesome icons -->
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="public/admin/images/2.png">
                <span class="username">
                    <?php
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="<?php echo e(URL::to('/add_category_product')); ?>">Thêm danh mục SP</a></li>
						<li><a href="<?php echo e(URL::to('/all_category_product')); ?>">Thông kê</a></li>
                    </ul>
                </li>
...
<!-- calendar -->
	<script type="text/javascript" src="public/admin/js/monthly.js"></script>
...
<?php /**PATH D:\xampp1\htdocs\shop\resources\views/admin_layout.blade.php ENDPATH**/ ?>